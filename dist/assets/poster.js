...
}`;function se(){if(document.getElementById("poster-environment"))return()=>{};const i=document.createElement("div");i.id="poster-environment",i.setAttribute("aria-hidden","true"),i.style.cssText="position:fixed;inset:0;overflow:hidden;pointer-events:none;z-index:1;background:#050506;",document.body.appendChild(i);const r=matchMedia("(prefers-reduced-motion: reduce)");let n;try{n=new N({alpha:!0,antialias:!1,powerPreference:"low-power"})}catch{return i.remove(),()=>{}}n.setClearColor(328966,0),i.appendChild(n.domElement);const t={uFrom:{value:null},uTo:{value:null},uResolution:{value:new G(innerWidth,innerHeight)},uTime:{value:0},uProgress:{value:0},uIndex:{value:0},uIntro:{value:0},uFromAspect:{value:1},uToAspect:{value:1},uFromFull:{value:0},uToFull:{value:0}},E=new j({uniforms:t,vertexShader:"varying vec2 vUv;void main(){vUv=uv;gl_Position=vec4(position.xy,0.,1.);}",fragmentShader:ae,depthTest:!1,depthWrite:!1,transparent:!0}),L=new V(2,2),M=new X,z=new _;M.add(new O(L,E));let m=[],u=0,x=0,l=0,c=!1,f=!1,I=0,w=0,R=!1,b=!1;const q=[],U=v.map(()=>[.5,.5,.5]);function B(e,o){if(!e.image)return;const a=document.createElement("canvas");a.width=32,a.height=32;const s=a.getContext("2d");if(s)try{s.drawImage(e.image,0,0,32,32);const p=s.getImageData(0,0,32,32).data,h=[0,0,0];let g=0;for(let d=0;d<p.length;d+=4){const S=p[d+3]/255;g+=S;for(let T=0;T<3;T++)h[T]+=p[d+T]/255*S}g&&(U[o]=h.map(d=>d/g))}catch{}}function F(){n.setPixelRatio(re(innerWidth,innerHeight,window.devicePixelRatio||1)),n.setSize(innerWidth,innerHeight),t.uResolution.value.set(innerWidth,innerHeight),f&&r.matches&&P()}function P(){const e=ne(u);t.uTime.value=u,t.uIndex.value=e.index,t.uProgress.value=e.progress,t.uFrom.value=m[e.from],t.uTo.value=m[e.to];const o=m[e.from].image,a=m[e.to].image;if(t.uFromAspect.value=o!=null&&o.naturalWidth&&(o!=null&&o.naturalHeight)?o.naturalWidth/o.naturalHeight:1,t.uToAspect.value=a!=null&&a.naturalWidth&&(a!=null&&a.naturalHeight)?a.naturalWidth/a.naturalHeight:1,t.uFromFull.value=Number(v[e.from].full),t.uToFull.value=Number(v[e.to].full),t.uIntro.value=r.matches?1:Math.min(1,u/4),n.render(M,z),u-I>.2||r.matches){I=u;const s=U[e.from],p=U[e.to];window.dispatchEvent(new CustomEvent("ka-ambient-light",{detail:{color:s.map((h,g)=>h+(p[g]-h)*e.progress),strength:(.048+.012*Math.sin(e.progress*Math.PI))*t.uIntro.value,reflection:{from:o,to:a,blend:e.progress,time:u,index:e.index,aspect:innerWidth/innerHeight,fromAspect:t.uFromAspect.value,toAspect:t.uToAspect.value,fromFull:t.uFromFull.value,toFull:t.uToFull.value}}}))}}function W(e){if(l=0,c||document.hidden||r.matches||!f||b)return;const o=x?e-x:33.4;if(o<(R?49:32)){l=requestAnimationFrame(W);return}w=o>65?w+1:Math.max(0,w-1),w>60&&(R=!0),u+=Math.min(.08,o/1e3),x=e,P(),y(!1)}function y(e=!0){f&&!c&&!document.hidden&&!r.matches&&!l&&!b&&(e&&(x=0),l=requestAnimationFrame(W))}function k(){document.hidden?(cancelAnimationFrame(l),l=0):y()}function A(){cancelAnimationFrame(l),l=0,f&&(r.matches?P():y())}function C(e){e.preventDefault(),b=!0,cancelAnimationFrame(l),l=0}function D(){b=!1,F(),A()}function H(){c||(c=!0,cancelAnimationFrame(l),window.removeEventListener("resize",F),document.removeEventListener("visibilitychange",k),r.removeEventListener("change",A),n.domElement.removeEventListener("webglcontextlost",C),n.domElement.removeEventListener("webglcontextrestored",D),q.forEach(e=>e.dispose()),L.dispose(),E.dispose(),n.dispose(),i.remove())}window.addEventListener("resize",F),document.addEventListener("visibilitychange",k),r.addEventListener("change",A),n.domElement.addEventListener("webglcontextlost",C),n.domElement.addEventListener("webglcontextrestored",D),F();const K=new J;return Promise.all(v.map(({url:e})=>new Promise((o,a)=>{K.load(e,s=>{if(c){s.dispose(),o(s);return}s.minFilter=Q,s.magFilter=Y,q.push(s),o(s)},void 0,a)}))).then(e=>{c||(m=e,e.forEach(B),f=!0,A())}).catch(H),H}export{v as artworkSources,ae as fragmentShader,re as renderBudget,se as startPosterBackground,ne as transitionState};
