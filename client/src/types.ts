export type Project={id:string;slug:string;title:string;cat:string;src?:string;widths:number[];full:number;description:string;technologies:string[];link:string;downloadable?:boolean};
